    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              foreach ($countries as $country){
                  print "<a href=\"list.php?country=$country\" role=\"button\" class=\"btn btn-default\"> $country</a>";
              }
		...
		<ul class="caption-style-2">
          ...
          //you need to fill the elements with data provided
            ...
            foreach ($images as $image){
                ...
                $imageCity = $image["city"];
                $imageUser = $image["user"];
                $imageTaken = $image["taken"];
                $imageTags = $image["tags"];
                print "<li>
                <a href=\"detail.php?id=$imageId\" class=\"img-responsive\">
				<img src=\"images/square/$imagePath\" alt=\"$imageTitle\">
				<div class=\"caption\">
					<div class=\"blur\"></div>
